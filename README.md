# Wordle Solver
Wordle Solver is a web application used to solve the [Wordle](https://www.nytimes.com/games/wordle/index.html) daily puzzle.

You type a guess into Wordle and put the result in the Solver.
You can input the word by typing or using the onscreen keyboard and the colors by either right or left clicking the letters.
